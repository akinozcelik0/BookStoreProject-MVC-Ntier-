...
using RaidBookStore.Migrations;
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult CancelOrder()
        {
            ...
            if (orderHeader.PaymentStatus == StaticDetails.PaymentStatusApproved)
            {
                ...
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, StaticDetails.StatusCanceled, StaticDetails.StatusRefunded);
            }
            else
            {
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, StaticDetails.StatusCanceled, StaticDetails.StatusCanceled);
            }
            _unitOfWork.Save();
